import { g as Na, r as _a } from "./index-pcvojpNF.js";
var Co = { exports: {} },
	ve = {},
	xo = { exports: {} },
	_o = {}; /**
...
((e) => {
	...
	function r(C) {
		...
		if (P !== z) {
			C[0] = P;
			for (var H = 0, Y = C.length, Yt = Y >>> 1; H < Yt; ) {
				var pn = 2 * (H + 1) - 1,
					sl = C[pn],
					mn = pn + 1,
					Xt = C[mn];
	...
	(e.unstable_IdlePriority = 5),
		...
		(e.unstable_cancelCallback = (C) => {
			C.callback = null;
		}),
		(e.unstable_continueExecution = () => {
			w || g || ((w = !0), il(E));
		}),
		(e.unstable_forceFrameRate = (C) => {
			0 > C || 125 < C
				? console.error(
		...
		(e.unstable_getFirstCallbackNode = () => t(s)),
		(e.unstable_next = (C) => {
			switch (p) {
				case 1:
				case 2:
		...
		(e.unstable_runWithPriority = (C, z) => {
			switch (C) {
				case 1:
				case 2:
				case 3:
		...
		(e.unstable_scheduleCallback = (C, z, P) => {
			...
			return (
				...
				P > H
					? ((C.sortIndex = P),
						...
						t(s) === null &&
							C === t(d) &&
							(k ? (f(N), (N = -1)) : (k = !0), ol(h, P - H)))
					: ((C.sortIndex = Y), n(s, C), w || g || ((w = !0), il(E))),
				C
			);
		}),
		(e.unstable_shouldYield = Ce),
		(e.unstable_wrapCallback = (C) => {
			var z = p;
			return function () {
				var P = p;
				p = z;
...
var Jt,
	Oo = ((e) =>
		typeof MSApp < "u" && MSApp.execUnsafeLocalFunction
			? (n, t, r, l) => {
					MSApp.execUnsafeLocalFunction(() => e(n, t, r, l));
				}
			: e)((e, n) => {
...
function nf(e, n, t, r, l) {
	switch (n) {
		...
		case "gotpointercapture":
			return (
				(u = l.pointerId), Lt.set(u, ot(Lt.get(u) || null, e, n, t, r, l)), !0
			);
	}
	return !1;
}
...
function cr(e) {
	...
	for (var n = e.targetContainers; 0 < n.length; ) {
		...
		} else return (n = $t(t)), n !== null && Ou(n), (e.blockedOn = t), !1;
		n.shift();
	}
	return !0;
}
...
function tf() {
	(Jl = !1),
		be !== null && cr(be) && (be = null),
		en !== null && cr(en) && (en = null),
...
function st(e, n) {
	e.blockedOn === n &&
		...
		Jl ||
			((Jl = !0),
			me.unstable_scheduleCallback(me.unstable_NormalPriority, tf)));
}
function Mt(e) {
	function n(l) {
		return st(l, e);
	...
	while (0 < Ge.length && ((t = Ge[0]), t.blockedOn === null))
...
var zr = null;
function ql(e, n, t, r) {
	if (((zr = null), (e = Du(r)), (e = yn(e)), e !== null))
		...
		movementX: (e) =>
			"movementX" in e
				...
				: (e !== at &&
						...
						(at = e)),
					ml),
		movementY: (e) => ("movementY" in e ? e.movementY : vl),
	}),
	Li = he(Kr),
	of = V({}, Kr, { dataTransfer: 0 }),
	sf = he(of),
	af = V({}, Wt, { relatedTarget: 0 }),
	hl = he(af),
	ff = V({}, nt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
	cf = he(ff),
	df = V({}, nt, {
		clipboardData: (e) =>
...
var wf = V({}, Wt, {
		...
		locale: 0,
		getModifierState: Vu,
		charCode: (e) => (e.type === "keypress" ? pr(e) : 0),
		keyCode: (e) =>
	...
	Cf = he(Ef),
	xf = V({}, nt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
	_f = he(xf),
	Nf = V({}, Kr, {
		deltaX: (e) =>
	...
	zf = he(Nf),
	Pf = [9, 13, 27, 32],
	Au = Be && "CompositionEvent" in window,
	wt = null;
Be && "documentMode" in document && (wt = document.documentMode);
var Tf = Be && "TextEvent" in window && !wt,
	ls = Be && (!Au || (wt && 8 < wt && 11 >= wt)),
	Ri = " ",
	Fi = !1;
function us(e, n) {
	switch (e) {
...
function Lf(e, n) {
	switch (e) {
		case "compositionend":
			return is(n);
		case "keypress":
			return n.which !== 32 ? null : ((Fi = !0), Ri);
		case "textInput":
...
function Mf(e, n) {
	if (Dn)
		return e === "compositionend" || (!Au && us(e, n))
			? ((e = rs()), (dr = ju = Je = null), (Dn = !1), e)
			: null;
	switch (e) {
		case "paste":
			return null;
...
function Of(e, n, t) {
	e === "focusin"
		? (ji(), (kt = n), (Dt = t), kt.attachEvent("onpropertychange", as))
		: e === "focusout" && ji();
}
function If(e) {
...
var Bf = Be && "documentMode" in document && 11 >= document.documentMode,
	Rn = null,
	bl = null,
	St = null,
	eu = !1;
...
for (var kl = 0; kl < Bi.length; kl++) {
	var Sl = Bi[kl],
		Hf = Sl.toLowerCase(),
		Qf = Sl[0].toUpperCase() + Sl.slice(1);
	fn(Hf, "on" + Qf);
}
...
var ht =
	...
	Wf = new Set("cancel close invalid load scroll toggle".split(" ").concat(ht));
function Hi(e, n, t) {
...
function Ft(e) {
	if (!e[rr]) {
		(e[rr] = !0),
			No.forEach((t) => {
				t !== "selectionchange" && (Wf.has(t) || El(t, !1, e), El(t, !0, e));
			});
				...
				for (var a = d, c; a !== null; ) {
					...
					if (
						(c.tag === 5 &&
							h !== null &&
							((c = h),
							f !== null && ((h = Pt(a, f)), h != null && k.push(Ot(a, h, c)))),
						O)
					)
						break;
					a = a.return;
				...
				if (
					...
					if (
						...
						n: {
							...
							while (0 < a - c) (k = Tn(k)), a--;
							while (0 < c - a) (f = Tn(f)), c--;
							while (a--) {
			...
			N &&
				(ls &&
					...
					(Dn || N !== "onCompositionStart"
						...
						: ((Je = v),
							(ju = "value" in Je ? Je.value : Je.textContent),
							(Dn = !0))),
				(x = Pr(d, N)),
				0 < x.length &&
					((N = new Mi(N, e, null, t, v)),
...
function Pr(e, n) {
	for (var t = n + "Capture", r = []; e !== null; ) {
		...
		l.tag === 5 &&
			...
			((l = u),
			(u = Pt(e, t)),
			u != null && r.unshift(Ot(e, u, l)),
			(u = Pt(e, n)),
			u != null && r.push(Ot(e, u, l))),
			(e = e.return);
	}
	return r;
}
...
function Qi(e, n, t, r, l) {
	for (var u = n._reactName, i = []; t !== null && t !== r; ) {
		...
		o.tag === 5 &&
			...
			((o = d),
			l
				? ((s = Pt(t, u)), s != null && i.unshift(Ot(t, s, o)))
				: l || ((s = Pt(t, u)), s != null && i.push(Ot(t, s, o)))),
			(t = t.return);
	}
...
var lu = typeof setTimeout == "function" ? setTimeout : void 0,
	...
	Xf =
		typeof queueMicrotask == "function"
			? queueMicrotask
			: typeof $i < "u"
				? (e) => $i.resolve(null).then(e).catch(Gf)
				: lu;
function Gf(e) {
	setTimeout(() => {
		throw e;
...
var tt = Math.random().toString(36).slice(2),
	...
	uu = "__reactEvents$" + tt,
	Zf = "__reactListeners$" + tt,
	Jf = "__reactHandles$" + tt;
function yn(e) {
	var n = e[Re];
	if (n) return n;
...
function ur(e) {
	...
	if (
		((n = e.tag !== 3) &&
			!(n = e.tag !== 5) &&
			((n = e.type),
			(n = n !== "head" && n !== "body" && !ru(e.type, e.memoizedProps))),
		n && (n = de))
	) {
		if (ou(e)) throw (xs(), Error(y(418)));
		while (n) Cs(e, n), (n = tn(n.nextSibling));
	}
	if ((Zi(e), e.tag === 13)) {
...
function _s(e) {
	...
	function t(f, a) {
		if (!e) return null;
		while (a !== null) n(f, a), (a = a.sibling);
		return null;
	}
	function r(f, a) {
	...
	function o(f, a, c, h) {
		return a === null || a.tag !== 6
			? ((a = Dl(c, f.mode, h)), (a.return = f), a)
			: ((a = l(a, c)), (a.return = f), a);
	}
	function s(f, a, c, h) {
		var E = c.type;
		return E === Mn
			? v(f, a, c.props.children, h, c.key)
			: a !== null &&
					(a.elementType === E ||
						(typeof E == "object" &&
							E !== null &&
							E.$$typeof === Ye &&
							Ji(E) === a.type))
				? ((h = l(a, c.props)), (h.ref = ft(f, a, c)), (h.return = f), h)
				: ((h = kr(c.type, c.key, c.props, null, f.mode, h)),
					(h.ref = ft(f, a, c)),
					(h.return = f),
					h);
	}
	function d(f, a, c, h) {
		return a === null ||
			...
			? ((a = Rl(c, f.mode, h)), (a.return = f), a)
			: ((a = l(a, c.children || [])), (a.return = f), a);
	}
	function v(f, a, c, h, E) {
		return a === null || a.tag !== 7
			? ((a = Sn(c, f.mode, h, E)), (a.return = f), a)
			: ((a = l(a, c)), (a.return = f), a);
	}
	function m(f, a, c) {
		...
		if (typeof a == "object" && a !== null) {
			switch (a.$$typeof) {
				case Gt:
					return (
						(c = kr(a.type, a.key, a.props, null, f.mode, c)),
						(c.ref = ft(f, null, a)),
						(c.return = f),
						c
					);
			...
			if (mt(a) || ut(a))
				return (a = Sn(a, f.mode, c, null)), (a.return = f), a;
			ir(f, a);
		}
		return null;
	}
	...
	function g(f, a, c, h, E) {
		if ((typeof h == "string" && h !== "") || typeof h == "number")
			return (f = f.get(c) || null), o(a, f, "" + h, E);
	...
	function w(f, a, c, h) {
		...
		if (_ === null) {
			for (; N < c.length; N++)
				(_ = m(f, c[N], h)),
					_ !== null &&
						((a = u(_, a, N)), x === null ? (E = _) : (x.sibling = _), (x = _));
			return I && vn(f, N), E;
		}
		for (_ = r(f, _); N < c.length; N++)
			(B = g(_, f, N, c[N], h)),
				B !== null &&
					...
					(x = B));
		return e && _.forEach((Ce) => n(f, Ce)), I && vn(f, N), E;
	}
	function k(f, a, c, h) {
		var E = ut(c);
		...
		for (
			var x = (E = null), _ = a, N = (a = 0), B = null, T = c.next();
			_ !== null && !T.done;
			N++, T = c.next()
		) {
			_.index > N ? ((B = _), (_ = null)) : (B = _.sibling);
		...
		if (_ === null) {
			for (; !T.done; N++, T = c.next())
				(T = m(f, T.value, h)),
					T !== null &&
						((a = u(T, a, N)), x === null ? (E = T) : (x.sibling = T), (x = T));
			return I && vn(f, N), E;
		}
		for (_ = r(f, _); !T.done; N++, T = c.next())
			(T = g(_, f, N, T.value, h)),
				T !== null &&
					...
					x === null ? (E = T) : (x.sibling = T),
					(x = T));
		return e && _.forEach((rt) => n(f, rt)), I && vn(f, N), E;
	}
	function O(f, a, c, h) {
		if (
			(typeof c == "object" &&
			...
			switch (c.$$typeof) {
				case Gt:
					e: {
						...
						c.type === Mn
							? ((a = Sn(c.props.children, f.mode, h, c.key)),
								(a.return = f),
								(f = a))
							: ((h = kr(c.type, c.key, c.props, null, f.mode, h)),
								(h.ref = ft(f, a, c)),
		...
		return (typeof c == "string" && c !== "") || typeof c == "number"
			? ((c = "" + c),
				a !== null && a.tag === 6
					...
					: (t(f, a), (a = Dl(c, f.mode, h)), (a.return = f), (f = a)),
				i(f))
			: t(f, a);
	}
	return O;
...
function ei(e, n, t, r, l, u) {
	if (
		...
		(n.updateQueue = null),
		(n.lanes = 0),
		(vr.current = e === null || e.memoizedState === null ? lc : uc),
		(e = t(r, l)),
		Et)
	) {
		u = 0;
...
function Pl(e) {
	...
	if (((e = t.interleaved), e !== null)) {
		l = e;
		do (u = l.lane), (U.lanes |= u), (_n |= u), (l = l.next);
		while (l !== e);
...
var Vr = {
	...
	lc = {
		readContext: Se,
		useCallback: (e, n) => (
			(De().memoizedState = [e, n === void 0 ? null : n]), e
		),
		useContext: Se,
		useEffect: no,
		...
		useLayoutEffect: (e, n) => hr(4194308, 4, e, n),
		useInsertionEffect: (e, n) => hr(4, 2, e, n),
		useMemo: (e, n) => {
			var t = De();
			return (
		...
		useState: eo,
		useDebugValue: ri,
		useDeferredValue: (e) => (De().memoizedState = e),
		useTransition: () => {
			var e = eo(!1),
				n = e[0];
		...
		useSyncExternalStore: (e, n, t) => {
			...
			return (
				(l.queue = u),
				no(Fs.bind(null, r, u, e), [e]),
				(r.flags |= 2048),
				Bt(9, Rs.bind(null, r, u, t, n), void 0, null),
				t
			);
		},
		useId: () => {
...
function cu(e, n, t, r) {
	...
	typeof u == "object" && u !== null
		? (l.context = Se(u))
		: ((u = ae(n) ? En : te.current), (l.context = Gn(e, u))),
	...
	return (
		...
		e !== null && !oe
			? ((n.updateQueue = e.updateQueue),
				...
				(e.lanes &= ~l),
				We(e, n, l))
			: (I && t && Hu(n), (n.flags |= 1), re(e, n, r, l), n.child)
	);
}
function so(e, n, t, r, l) {
	if (e === null) {
		...
		return typeof u == "function" &&
			...
			? ((n.tag = 15), (n.type = u), qs(e, n, u, r, l))
	...
	if (((u = e.child), !(e.lanes & l))) {
		...
		if (
			((t = t.compare), (t = t !== null ? t : Rt), t(i, r) && e.ref === n.ref)
		)
			return We(e, n, l);
	}
	return (
	...
	return (
		...
		e !== null && !oe
			? ((n.updateQueue = e.updateQueue),
				...
				(e.lanes &= ~l),
				We(e, n, l))
			: (I && r && Hu(n), (n.flags |= 1), re(e, n, t, l), n.child)
	);
}
function ao(e, n, t, r, l) {
	...
	if ((Kn(n, l), n.stateNode === null))
		yr(e, n), Gs(n, t, r), cu(n, t, r, l), (r = !0);
	else if (e === null) {
		var i = n.stateNode,
			o = n.memoizedProps;
		i.props = o;
		...
		(i.state = p),
			...
			o !== r || p !== s || se.current || Xe
				? (typeof v == "function" && (fu(n, t, v, r), (s = n.memoizedState)),
		...
		o !== m || p !== w || se.current || Xe
			? (typeof g == "function" && (fu(n, t, g, r), (w = n.memoizedState)),
...
function mu(e, n, t, r, l, u) {
	ea(e, n);
	var i = (n.flags & 128) !== 0;
	if (!r && !i) return l && Xi(n, t, !1), We(e, n, u);
	...
	return (
		(n.flags |= 1),
		e !== null && i
			? ((n.child = Jn(n, e.child, null, u)), (n.child = Jn(n, null, o, u)))
			: re(e, n, o, u),
...
function ta(e, n, t) {
	...
	if (u) {
		...
		return (
			...
			o !== null ? (u = on(o, u)) : ((u = Sn(u, i, t, null)), (u.flags |= 2)),
			(u.return = n),
			(r.return = n),
			(r.sibling = u),
			(n.child = r),
	...
	return (
		(u = e.child),
		(e = u.sibling),
		(r = on(u, { mode: "visible", children: r.children })),
		!(n.mode & 1) && (r.lanes = t),
		(r.return = n),
		(r.sibling = null),
		e !== null &&
...
function ac(e, n, t, r, l, u, i) {
	if (t)
		return n.flags & 256
			? ((n.flags &= -257), (r = Ll(Error(y(422)))), or(e, n, i, r))
			: n.memoizedState !== null
	...
	if (((o = (i & e.childLanes) !== 0), oe || o)) {
		if (((r = G), r !== null)) {
			...
			(l = l & (r.suspendedLanes | i) ? 0 : l),
				l !== 0 &&
					l !== u.retryLane &&
					((u.retryLane = l), Qe(e, l), Te(r, e, l, -1));
		}
	...
	switch ((Qu(n), n.tag)) {
				...
				(e === null || e.child === null) &&
					(ur(n)
						...
						: e === null ||
							...
							((n.flags |= 1024), ze !== null && (_u(ze), (ze = null)))),
				yu(e, n),
				ee(n),
				null
			);
			...
			return n.flags & 128
				...
				: ((r = r !== null),
					r !== (e !== null && e.memoizedState !== null) &&
						...
						((n.child.flags |= 8192),
						n.mode & 1 &&
							(e === null || j.current & 1 ? K === 0 && (K = 3) : fi())),
					n.updateQueue !== null && (n.flags |= 4),
					ee(n),
					null);
		case 4:
			return (
				qn(), yu(e, n), e === null && Ft(n.stateNode.containerInfo), ee(n), null
			);
		case 10:
		...
		case 19:
			...
			if (((r = (n.flags & 128) !== 0), (i = u.rendering), i === null))
				if (r) ct(u, !1);
					...
					u.tail !== null &&
						Q() > et &&
						((n.flags |= 128), (r = !0), ct(u, !1), (n.lanes = 4194304));
				}
			else {
				if (!r)
					if (((e = jr(i)), e !== null)) {
						if (
							...
							ct(u, !0),
							u.tail === null && u.tailMode === "hidden" && !i.alternate && !I)
						)
							return ee(n), null;
					} else
						2 * Q() - u.renderingStartTime > et &&
							t !== 1073741824 &&
							((n.flags |= 128), (r = !0), ct(u, !1), (n.lanes = 4194304));
				u.isBackwards
		...
		case 23:
			return (
				...
				r && n.mode & 1
					? ce & 1073741824 && (ee(n), n.subtreeFlags & 6 && (n.flags |= 8192))
					: ee(n),
				null
			);
		case 24:
...
function mc(e, n) {
	...
	for (tu = { focusedElem: e, selectionRange: t }, Nr = !1, S = n; S !== null; )
...
function oa(e) {
	...
	n !== null && ((e.alternate = null), oa(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null &&
				(delete n[Re], delete n[It], delete n[uu], delete n[Zf], delete n[Jf])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
...
function ku(e, n, t) {
	...
	if (r === 5 || r === 6)
		...
		for (ku(e, n, t), e = e.sibling; e !== null; ) ku(e, n, t), (e = e.sibling);
}
function Su(e, n, t) {
	var r = e.tag;
	if (r === 5 || r === 6)
		...
		case 5:
			...
			if (r & 4 && ((l = e.stateNode), l != null)) {
				...
				if (((e.updateQueue = null), s !== null))
					try {
						o === "input" && u.type === "radio" && u.name != null && Do(l, u),
							$l(o, i);
						var d = $l(o, u);
						...
						(i = S),
							...
							i.tag === 22 && i.memoizedState !== null
								...
								: s !== null
									? ((s.return = i), (S = s))
									: go(l);
				while (u !== null) (S = u), ca(u), (u = u.sibling);
				(S = l), (sr = o), (ne = d);
			}
			ho(e);
		} else
			l.subtreeFlags & 8772 && u !== null ? ((u.return = l), (S = u)) : ho(e);
	}
}
function ho(e) {
	while (S !== null) {
...
function fe(e, n) {
	...
	var r = _r(e, e === G ? J : 0);
	if (r === 0)
		t !== null && Ni(t), (e.callbackNode = null), (e.callbackPriority = 0);
	else if (((n = r & -r), e.callbackPriority !== n)) {
		if ((t != null && Ni(t), n === 1))
			e.tag === 0 ? qf(wo.bind(null, e)) : Ss(wo.bind(null, e)),
				Xf(() => {
					!(L & 6) && dn();
				}),
				(t = null);
...
function da(e, n) {
	...
	if (n !== 0) {
		if (
			(n === 2 && ((l = Zl(e)), l !== 0 && ((r = l), (n = xu(e, l)))), n === 1)
		)
			throw ((t = Ht), kn(e, 0), Ze(e, r), fe(e, Q()), t);
		if (n === 6) Ze(e, r);
		else {
			if (
			...
			switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
				...
				case 3:
					if (
						(Ze(e, r), (r & 130023424) === r && ((n = oi + 500 - Q()), 10 < n))
					) {
						if (_r(e, 0) !== 0) break;
...
function kn(e, n) {
	...
	if ((t !== -1 && ((e.timeoutHandle = -1), Yf(t)), W !== null))
...
function Sc(e, n, t) {
	...
	r !== null && r.delete(n),
		...
		G === e &&
			(J & t) === t &&
			(K === 4 || (K === 3 && (J & 130023424) === J && 500 > Q() - oi)
				? kn(e, 0)
				: (ii |= t)),
		fe(e, n);
}
...
ga = (e, n, t) => {
	if (e !== null)
		if (e.memoizedProps !== n.pendingProps || se.current) oe = !0;
			...
			if (!(e.lanes & t) && !(n.flags & 128)) return (oe = !1), fc(e, n, t);
			oe = !!(e.flags & 131072);
		}
	...
	switch (((n.lanes = 0), n.tag)) {
			...
			return (
				...
				l.$$typeof === void 0
					? ((n.tag = 1),
						...
						cu(n, r, e, t),
						(n = mu(null, n, r, !0, u, t)))
					: ((n.tag = 0), I && u && Hu(n), re(null, n, l, t), (n = n.child)),
				n
			);
		case 16:
			r = n.elementType;
		...
		case 5:
			return (
				...
				(i = l.children),
				ru(r, l) ? (i = null) : u !== null && ru(r, u) && (n.flags |= 32),
				ea(e, n),
				re(e, n, i, t),
				n.child
			);
...
function kr(e, n, t, r, l, u) {
	...
	if (((r = e), typeof e == "function")) ci(e) && (i = 1);
		...
		e: switch (e) {
			...
			case Ol:
				return (
					(e = we(12, t, n, l | 2)), (e.elementType = Ol), (e.lanes = u), e
				);
			case Il:
	...
	return (
		(n = we(i, t, n, l)), (n.elementType = e), (n.type = r), (n.lanes = u), n
	);
}
function Sn(e, n, t, r) {
...
rl.prototype.unstable_scheduleHydration = (e) => {
	if (e) {
		var n = bo();
	...
	switch (e.tag) {
		case 3:
			...
			if (n.current.memoizedState.isDehydrated) {
				...
				t !== 0 &&
					(Fu(n, t | 1), fe(n, Q()), !(L & 6) && ((et = Q() + 500), dn()));
			}
			break;
		case 13:
			Nn(() => {
...
Ao = si;
Bo = Nn;
var Lc = { usingClientEntryPoint: !1, Events: [$t, On, Gr, Uo, Vo, si] },
	dt = {
	...
	Mc = {
		...
		findHostInstanceByFiber: (e) => (
			(e = Wo(e)), e === null ? null : e.stateNode
		),
		findFiberByHostInstance: dt.findFiberByHostInstance || Pc,
...
ve.unstable_renderSubtreeIntoContainer = (e, n, t, r) => {
