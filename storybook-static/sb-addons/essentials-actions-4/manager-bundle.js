	...
	(() => {
		...
		var Fa = __STORYBOOK_CORE_EVENTS__,
			{
				...
				TOGGLE_WHATS_NEW_NOTIFICATIONS: ko,
				UNHANDLED_ERRORS_WHILE_PLAYING: jo,
				UPDATE_GLOBALS: Go,
		...
		function W(e) {
			...
			return (
				(W = (n) => {
					...
					function a() {
						return je(n, arguments, G(this).constructor);
					}
					return (
		...
		function I(e) {
			...
			if (s) {
				...
				return {
					red: Number.parseInt("" + f[1], 10),
					green: Number.parseInt("" + f[2], 10),
					blue: Number.parseInt("" + f[3], 10),
				};
			}
			var d = _t.exec(t.substring(0, 50));
			if (d) {
				var E = Number.parseInt("" + d[1], 10),
					m = Number.parseInt("" + d[2], 10) / 100,
					y = Number.parseInt("" + d[3], 10) / 100,
					O = "rgb(" + F(E, m, y) + ")",
					N = re.exec(O);
		...
		function Lt(e, t) {
			...
			var r = A(t);
			return C(_({}, r, { hue: r.hue + Number.parseFloat(e) }));
		}
		var bl = v(Lt);
		function D(e, t, r) {
		...
		function It(e, t) {
			...
			var r = A(t);
			return C(
				_({}, r, { lightness: D(0, 1, r.lightness - Number.parseFloat(e)) }),
			);
		}
		var gl = v(It);
		function Dt(e, t) {
			...
			var r = A(t);
			return C(
				_({}, r, { saturation: D(0, 1, r.saturation - Number.parseFloat(e)) }),
			);
		}
		var hl = v(Dt);
		function Mt(e, t) {
		...
		function zt(e, t) {
			return t === "transparent"
				? t
				: C(_({}, A(t), { hue: Number.parseFloat(e) }));
		}
		var Ol = v(zt);
		function kt(e, t) {
			return t === "transparent"
				? t
				: C(_({}, A(t), { lightness: Number.parseFloat(e) }));
		}
		var _l = v(kt);
		function jt(e, t) {
			return t === "transparent"
				? t
				: C(_({}, A(t), { saturation: Number.parseFloat(e) }));
		}
		var Tl = v(jt);
		function Gt(e, t) {
			return t === "transparent"
		...
		var Br = B(lt)({ margin: 0, padding: "10px 5px 20px" }),
			...
			zr = class extends Te {
				...
				componentDidMount() {
					...
					e.on(se, this.addAction), e.on(j, this.handleStoryChange);
				}
				componentWillUnmount() {
					this.mounted = !1;
					const { api: e } = this.props;
					e.off(j, this.handleStoryChange), e.off(se, this.addAction);
				}
				render() {
